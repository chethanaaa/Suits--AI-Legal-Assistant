...
openai_key = "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"
# Suppress warnings
logging.getLogger("cryptography").setLevel(logging.ERROR)
logging.getLogger("pypdf").setLevel(logging.ERROR)
